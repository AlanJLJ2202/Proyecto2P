 ...
 * @author AJLJ-
 */
public class nCategorias extends javax.swing.JDialog {
    ...
    public nCategorias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public nCategorias() {
     ...
     public nCategorias(int idCategoria) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nCategorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                nCategorias dialog = new nCategorias(new javax.swing.JFrame(), true);
